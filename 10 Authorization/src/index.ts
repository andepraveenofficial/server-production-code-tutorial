...
app.get("/products1", authMiddleware, async (req: Request, res: Response) => {
...
app.get(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ error: "An error occurred while fetching products3" });
    }
  }
);
...
app.get(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      console.error("Error fetching products4:", error);
      res
        .status(500)
        .json({ error: "An error occurred while fetching products4" });
    }
  }
);
